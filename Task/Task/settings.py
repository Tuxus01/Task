...
SECRET_KEY = '^o*26m*bcnofm!()_u^ig9ljromyc&t4okd-np%%-nuyi22@&_'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'Task4.sqlite3'),
    }
}
...
FCM_DJANGO_SETTINGS  = {
    ...
    "FCM_SERVER_KEY": "AAAA4XX64VU:APA91bH3q9qRCZschremqTWchnCOcLhQJ7jTiT6GFGT5WPnVOJ4EI4YYVeE6t1FVuLhme3vIqd_0lPga7BHcqiP8JIRZ-vu9R7OZpNj_VzEvKXOYIBI9I6tZJJajRbu4StJ2MyN8P7HU2",
